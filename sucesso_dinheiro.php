...
<body>
    ...
    <main>
        <div class="banner">
            <h2>Procure o caixa ou um atendente para concluir o pagamento.</h2>
            <p>Seu pedido foi registrado com sucesso. O pagamento deverá ser realizado em dinheiro diretamente no caixa, atendente ou entregador.</p>
